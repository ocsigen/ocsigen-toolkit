...
val cropper : 
  ...
  ?ratio:float ->
  unit ->
  (unit -> unit) * cropping * [> `Div ] Eliom.Content.Html.elt
```
...
val bind_input : 
  ...
  ?container:Js_of_ocaml.Dom_html.element Js_of_ocaml.Js.t Eliom.Client_value.t ->
  ?reset:(unit -> unit) ->
  unit ->
  unit
```
...
val bind : 
  ?container:Js_of_ocaml.Dom_html.element Js_of_ocaml.Js.t Eliom.Client_value.t ->
  input:Js_of_ocaml.Dom_html.inputElement Js_of_ocaml.Js.t Eliom.Client_value.t ->
  preview:Js_of_ocaml.Dom_html.imageElement Js_of_ocaml.Js.t ->
  ?crop:((unit -> unit) * cropping) ->
  submit:Js_of_ocaml.Dom_html.eventTarget Js_of_ocaml.Js.t Eliom.Client_value.t ->
  upload:unit upload ->
  after_submit:(unit -> unit Lwt.t) ->
  unit ->
  unit
