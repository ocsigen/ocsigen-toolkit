...
val reactive_toggle_button : 
  ...
  [< Html_types.button_content ] Eliom.Content.Html.elt list ->
  [> `Button ] Eliom.Content.Html.elt * bool react_component
```
...
val optional_int_input : 
  ...
  int option ->
  [> `Div ] Eliom.Content.Html.elt
  * (int option, unit) result Eliom.Shared.React.S.t
```
...
val int_input : 
  ...
  ?size:int ->
  int ->
  [> `Div ] Eliom.Content.Html.elt * (int, unit) result Eliom.Shared.React.S.t
```
...
val reactive_select : 
  ...
  ?selected:string ->
  unit ->
  [> `Select ] Eliom.Content.Html.elt * string react_component
```
...
val reactive_date_input : 
  ...
  ?value:(int * int * int) ->
  unit ->
  [> `Input ] Eliom.Content.Html.elt * (int * int * int) option react_component
```
...
val reactive_time_input : 
  ...
  ?value:(int * int) ->
  unit ->
  [> `Input ] Eliom.Content.Html.elt * (int * int) option react_component
```
