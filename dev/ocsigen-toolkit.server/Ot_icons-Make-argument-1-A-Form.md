...
NB that the default value of `~xhr` is configurable through [`Eliom_config.set_default_links_xhr`](./../../eliom/eliom.server/Eliom_config.md#val-set_default_links_xhr).
